...
import karrio.providers.chitchat_test.error as error
import karrio.providers.chitchat_test.utils as provider_utils
import karrio.providers.chitchat_test.units as provider_units
...
def shipment_request(
    ...
    request = None  # map data to convert karrio model to chitchat_test specific type
